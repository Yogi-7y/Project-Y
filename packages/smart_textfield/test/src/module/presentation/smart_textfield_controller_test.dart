...
// import 'package:smart_textfield/src/module/presentation/smart_textfield_controller_deprecated.dart';

// void main() {
//   late SmartTextFieldControllerDeprecated controller;

//   setUp(() {
//     controller = SmartTextFieldControllerDeprecated(
...
//               TextSelection.fromPosition(TextPosition(offset: 13));
...
//         'initially is (-1, -1)',
//         () => expect(
//             controller.activePatternOffset, equals((start: -1, end: -1))),
//       );
...
//         controller.text = 'Hello, World!';
//         controller.selection = TextSelection.fromPosition(
//             const TextPosition(offset: 5)); // Cursor is at position 5
...
//         controller.text = '';
//         controller.selection = TextSelection.fromPosition(
//             const TextPosition(offset: 0)); // Cursor is at position 0
